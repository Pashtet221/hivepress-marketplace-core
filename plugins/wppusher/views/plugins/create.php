    ...
    <table class="form-table">
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <input id="wppusher-repository-name" name="wppusher[repository]" type="text" class="regular-text" value="<?php echo (isset($_POST['wppusher']['repository'])) ? esc_attr($_POST['wppusher']['repository']) : ''; ?>">
            ...
            <tr>
                ...
                <td>
                    <input name="wppusher[branch]" type="text" class="regular-text" placeholder="master, main, development etc." value="<?php echo (isset($_POST['wppusher']['branch'])) ? esc_attr($_POST['wppusher']['branch']) : ''; ?>">
            ...
            <tr>
                ...
                <td>
                    <input name="wppusher[subdirectory]" type="text" class="regular-text" placeholder="Optional" value="<?php echo (isset($_POST['wppusher']['subdirectory'])) ? esc_attr($_POST['wppusher']['subdirectory']) : ''; ?>">
