...
<?php
    ...
    <?php else : ?>
        ...
        <p><strong>Status Code</strong>: <?php echo esc_html($code); ?></p>
        <p><strong>Response</strong>: <pre><?php echo esc_html($response); ?></pre>
        <p><strong>Headers</strong>: <pre><?php echo esc_html(print_r($headers, true)); ?></pre>
    <?php endif; ?>
...
<?php  
    ...
    <?php elseif( 200 !== $code ) : ?>
        ...
        <p><strong>Status Code</strong>: <?php echo esc_html($code); ?></p>
        <p><strong>Response</strong>: <pre><?php echo esc_html($response_body); ?></pre>
        <p><strong>Headers</strong>: <pre><?php echo esc_html(print_r($headers, true)); ?></pre>
    <?php else: ?>
        <strong style="color: green;">Status: Passed.</strong> You're all good!
    <?php endif; ?>
